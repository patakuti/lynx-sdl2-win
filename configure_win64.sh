...
./configure \
  ...
  --without-x \
  --disable-nls \
  CPPFLAGS="-I${PDCURSES_DIR} -I${SDL2_DIR}/include/SDL2 -I${SDL2_TTF_DIR}/include/SDL2 -I${OPENSSL_DIR}/include -I${ICONV_DIR}/include -DPDCURSES -DPDCURSES_SDL2 -DPDC_WIDE -DPDC_FORCE_UTF8 -DUSE_PROGRAM_DIR -DUSE_OPENSSL_INCL" \
